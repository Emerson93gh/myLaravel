<form class="md:w-1/2 space-y-3" wire:submit.prevent='editarVacante'>
    <div>
        ...
        <x-text-input id="titulo" class="block mt-1 w-full" type="text" wire:model="titulo"
            :value="old('titulo')" placeholder="Titulo de la vacante" autofocus />
    ...
    <div>
        <x-input-label for="descripcion" :value="__('Descripción de Puesto')" />
    ...
    <div>
        ...
        <div class="my-5 w-96">
            @if ($imagen_nueva)
                Imagen Nueva:
                <img src=" {{ $imagen_nueva->temporaryURL() }} " alt="Imagen cargada">
            @endif
        </div>
