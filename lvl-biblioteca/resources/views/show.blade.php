...
@section('content')
    <h1 class="page-header text-center">
        Laravel 9 * JQuery * Ajax * CRUD * Bootstrap 5
    </h1>
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <h2>Members Table
                <button type="button" id="add" class="btn btn-primary pull-rigth"
                data-bs-toggle="modal" data-bs-target="#addnew">Member</button>
            </h2>
        </div>
    </div>
    <div class="row">
